<%-- 
    Document   : viewBloodBankOrg
    Created on : Jul 21, 2021, 12:33:30 AM
    Author     : Hanna
--%>
        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            %>
                  ...
                  <tbody>
                    <tr>
                     <td> <%=n%> </td>
                      ...
                      <td>
                            <form name='req<%=bb.getBloodBagNum()%>' action='addRequestController.do' method='POST' >
                            <input type='hidden' name='bloodBagNum' value='<%=bb.getBloodBagNum()%>'>
                            <input type='hidden' name='reqQty' value='<%=bb.getBloodQty()%>'>
                            <input type='hidden' name='orgID' value='<%=orgID%>'>
                            <input type='hidden' name='reqStatus' value='Requested'>
                            <input type='hidden' name='admIC' value='none'>
                ...
                %>
                    <input type="hidden" name="requestDate" value="<%=formatter.format(requestDate)%>">
                            <a href='' onclick='if(confirm("Request this bag ?"))document.req<%=bb.getBloodBagNum()%>.submit();return false;'>REQUEST</a>
                  </form>
                  </td>
                  ...
                  <% n=n+1;
                    ...
                    <span style="color:red"><%=(request.getAttribute("errorMsgs") == null) ? ""
                         : request.getAttribute("errorMsgs") %></span>
                  </tbody>
                </table>
