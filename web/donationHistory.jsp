<%-- 
    ...
    Created on : Jul 20, 2021, 9:00:37 PM
    Author     : Hanna
--%>
...
response.sendRedirect("loginDonor.jsp");
 ...
 BBList = BBDao.getHistory(donorIC);
    %>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">List of Donation History</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">List of Donation History( <span style='color:blue;'><%=BBList.size() %></span> )</h3>
