...
public class UpdateDonorServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(!errorMsgs.isEmpty()){
                ...
                RequestDispatcher view = request.getRequestDispatcher("/updateDonorForm.jsp");
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("location='indexDonor.jsp';");
                out.println("</script>");
            }
    ...
    private void updateDonor(Donor donor) throws SQLException{
