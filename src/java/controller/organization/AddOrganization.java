 ...
 private PreparedStatement pstmt;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
           ...
           Organization org= new Organization(orgName, orgPass, orgState, orgAddress, orgNumtel,orgType, orgEmail,admIC);
            registerMember(org);
            request.setAttribute("org",org);
            try (PrintWriter out = response.getWriter()) {
                out.println("<script type='text/javascript'>");
                out.println("alert('Add successful');");
                out.println("location='orgChangePass.jsp';");
                out.println("</script>");
            }
    ...
    private void registerMember(Organization org) throws SQLException{
